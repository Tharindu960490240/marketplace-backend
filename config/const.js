let constants = {
  ...
  DB_HOST:
    process.env.DB_HOST ||
    "dpg-d83sdhfaqgkc73a3qr20-a.virginia-postgres.render.com",
  DB_PORT: process.env.DB_PORT || 5432,
  DB_NAME: process.env.DB_NAME || "sathwa_sewana",
  DB_USER: process.env.DB_USER || "marketplace_user",
  DB_PASSWORD: process.env.DB_PASSWORD || "eXhP7g0Nq16FstcAm2XSIZEk6MwxM4Sw",
  ...
  // Security & URLs
  JWT_SECRET: process.env.JWT_SECRET || "dilan_sathwa_sewana_secret_key_2026",
  JWT_EXPIRES_IN: "1h",
  LOGO_URL:
